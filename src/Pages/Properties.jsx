...
const Properties = () => {
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      ...
      try {
        ...
        // Exclude sold properties strictly
        const unsoldList = rawData.filter(
          (item) => item.availability_status?.toLowerCase() !== "sold"
        );
        
        setProperties(unsoldList);
      } catch (err) {
  ...
  // Filter logic for unsold properties
  const filteredProperties = properties.filter((p) => {
    ...
    // Matches dropdown against project_property_type or property_type
    const matchesType =
    ...
    // Handles "3 BHK +" range filtering properly
    const matchesBhk = (() => {
    ...
    <>
      ...
      <div className="properties-root">
        ...
        <div className="container px-4 py-4">
          {/* PAGE TITLE & SUBTITLE */}
          <div className="mb-4">
            <h1 className="fw-bold fs-2 mb-1">Available Properties</h1>
            <p className="text-muted">Browse through all active residential and commercial inventory.</p>
          </div>
          ...
          <div className="filter-header-card mb-5">
            <div className="row g-3">
              <div className="col-md-6 col-lg-3">
                <label className="form-label small fw-bold text-muted uppercase">Search Title / Project</label>
                <input
                  type="text"
                  name="search"
              ...
              <div className="col-md-4 col-lg-2">
                <label className="form-label small fw-bold text-muted">Max Budget</label>
                <select
                  name="max_price"
                  className="form-select custom-field-input"
          ...
          {loading ? (
            <div className="text-center py-5">
              ...
              <p className="mt-2 text-muted fw-semibold">Loading available properties...</p>
            </div>
                ...
                <div className="col-md-6 col-lg-4" key={prop.id}>
                  <div className="property-card h-100 d-flex flex-column">
                    <div className="property-img-wrapper">
                      ...
                      <span className="badge-status bg-success text-white">
            ...
            <div className="text-center py-5 bg-white rounded-4 border">
              <h4 className="fw-semibold text-muted mb-2">No active properties match your criteria</h4>
              <button
